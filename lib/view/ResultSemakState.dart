...
class ResultSemakState extends State<ResultSemak> {
  ...
  getMessage(BuildContext context) async {
    return new Future.delayed(TIMEOUT, () => 'Tiada Data'); //
  }
}